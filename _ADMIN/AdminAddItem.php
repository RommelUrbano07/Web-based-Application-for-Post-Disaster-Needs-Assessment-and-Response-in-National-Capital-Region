...
<html>
    <head>
        ...
        <title>iRespondPH - Add Item</title>
        <link
            rel="canonical"
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                                <h3 class="box-title">Donation Inventory - Add Item</h3>
                                <form action="AdminAddItemProcess.php" method="POST" class="form-horizontal form-material">
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <select class='form-control' name='ItemName' title='What items are in immediate need?' required>
                                        ...
                                        <br><br><br><br>
                                        <div class="col-sm-2">
                                            <input type="submit" value="Add Item" class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white;">
                                        </div>
                                    </div>
                                </form>
                            </div>
