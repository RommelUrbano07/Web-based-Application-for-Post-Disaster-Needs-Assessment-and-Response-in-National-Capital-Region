...
<html lang="en">
    <head>
        ...
        <title>iRespondPH - Donation Approval</title>
        <link
            rel="canonical"
    ...
    <body class="fix-header">
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title" style="font-size: 20px">Donation Approval</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Donation Approval</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="white-box">
                                <section>
                                    ...
                                    $PendingID=$Inventory->getDonationRequestID();
                                    ?>
                                    <center>
                                    <table class="content-table" style="margin-left: 12px">
                                        <thead >
                                            <tr>
                                                <th style="color: white; text-align: center">Donation ID</th>
                                                <th style="color: white; text-align: center">Item/s Name</th>
                                                <th style="color: white; text-align: center">Donor/s Name/s</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
                                            ...
                                            <tr class='tbodyDT' onclick='setActive(this);'>
                                                <td scope='row' align='center'> 
                                                   <span> <?php echo $id['DonationPendingID']; ?></span>
                                                </td>
                                                <td scope='row' align='center'>
                                                <?php 
                                                $result= $Inventory->getDonationPendingItems($id['DonationPendingID']);
                                                
                                                while($rows=mysqli_fetch_assoc($result)){
                                                    echo " '".$rows['item']."' : '".$rows['quantity']."'";
                                                    echo "<br>";
                                                }
                                                ?>
                                                </td>
                                                <td scope='row' align='center'>
                                                    <?php 
                                                $result= $Inventory->getDonationPendingDonors($id['DonationPendingID']);
                                                
                                                while($rows=mysqli_fetch_assoc($result)){
                                                    echo " '".$rows['fname']."' '".$rows['mname']."' '".$rows['lname']."' '".$rows['suffix']."' ";
                                                    echo "<br>";
                                                }
                                                ?>
                                                </td>
                                    ...
                                    <input type="button" button id='retriever' value="Approve Donation" class="btn btn-block waves-effect waves-light" onclick='retrieveRow();' style="background-color: orange; color: white; width: 170px" class='btn btn-primary'/>
                                    </section>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            function retrieveRow() {
                ...
                $.ajax({
                    type: "POST",
                    url: "DonationApprovalProcess.php",
                    data: {
                        DonationID: data[0]
                    },
