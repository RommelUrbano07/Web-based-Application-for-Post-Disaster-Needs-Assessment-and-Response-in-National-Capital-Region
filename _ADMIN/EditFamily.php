...
<html>
    ...
    <head>
        ...
        <title>iRespondPH - Edit Family</title>
        <link
            rel="canonical"
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title" style="font-size: 20px">Edit Family</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                <h1 style="text-align: center; font-weight: bold; margin-bottom: 10px">Edit Family</h1>
                                <section>
                                    <center>
                                    <table class="content-table" style="margin-left: 12px" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="color: white; text-align: center">Suffix</th>
                                                <th style="color: white; text-align: center">Birth Date</th>
                                                <th style="color: white; text-align: center">Contact No.</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $HeadFirstName = $_SESSION["HeadFirstName"];
                                            $HeadMiddleName = $_SESSION["HeadMiddleName"];
                                            $HeadLastName = $_SESSION["HeadLastName"];
                                            $HeadSuffix = $_SESSION["HeadSuffix"];
                                        ...
                                        <center>
                                            <div class="relative">
                                                <div class="navitem">
                                                    <input type="submit" value="Add Record"  class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; height: 50px"/>
                                                </div>
                                                </form>
                                                <div class="navitem">
                                                    <input type="button" value="Delete Record" button id='retriever' onclick='retrieveRow();' class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; height: 50px"/>
                                                </div>
                                            </div>
                                        </center>
                                </section>
