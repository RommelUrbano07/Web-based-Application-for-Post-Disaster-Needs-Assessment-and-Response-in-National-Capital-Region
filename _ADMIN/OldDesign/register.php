                    ...
                    <div class='tab-pane' id='ls'>
                        <fieldset id='fs'>
                            <div class='row'>
                                <div class='column'>
                                    <div class="form-group" >
                                        <input name='firstName0' type='text' class="form-control" placeholder="First Name" title='First Name' data-pattern='textOnly' required>
                                    </div>
                                </div>
                                <div class='column'>
                                    <div class="form-group">
                                        <input name='middleName0' type='text' class="form-control" placeholder="Middle Name" data-pattern='textOnly' required>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                                <div class='column'>
                                    <div class="form-group">
                                        <input name='lastName0' type='text' class="form-control" placeholder="Last Name" data-pattern='textOnly' required>
                                    </div>
                                </div>
                                <div class='column'>
                                    <div class="form-group">
                                        <input name='suffix0' type='text' class="form-control" placeholder='Suffix' data-pattern='textOnly'>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                                <div class='column'>
                                    <div class="form-group">
                                        <input name='contactNo0' class="form-control" type='tel' placeholder="Contact No." minlength=11 maxlength=13 title='Contact Number' data-pattern='numberOnly' required>
                                    </div>
                                </div>
                                <div class='column'>
                                    <div class="form-group">
                                        <input type='text' class="form-control" placeholder='House No.' name='houseNo0' title='House Number'>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                                <div class='column'>
                                    <div class="form-group">
                                        <input type='text' class="form-control" placeholder='Street Name' name='streetName0' title='Street Name' required>
                                    </div>
                                </div>
                                <div class='column'>
                                    <div class="form-group">
                            ...
                            <div class='row'>
                                <div class='column'>
                                    <div class="custom-select" style='height: auto;'>
                                        <input type='date' class="form-control"  placeholder="Birth Date" name='birthDate0' value="yyyy-mm-dd" class='birthdate' title='Birth Date' required>
                                    </div>
                                </div>
                                <div class='column'>
                                    <div class="custom-select" style='height: auto;'>
                            ...
                            <div class='row'>
                                <div class="column">
                                    <div class="form-check form-check-inline">
                                        <input type='radio' name='sex0' id='male0' value='1' class='form-check-input' required/>
                                        <label for='male0' class='form-check-label'>Male</label>
                                    </div>
                                </div>
                                <div class="column">
                                    <div class="form-check form-check-inline">
                                        <input type='radio' name='sex0' id='female0' value='0' class='form-check-input'/>
