...
<html>
    <head>
        ...
        <title>iRespondPH - Withdraw Item</title>
        <link
            rel="canonical"
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="WithdrawItem.php" class="waves-effect"><i class="fas fa-table" style="margin-right: 12px;"
                                                                                    aria-hidden="true"></i>Withdraw Item</a>
                        </li>
                        <li>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Donation Inventory</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Donation Inventory</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
...
$result=$Inventory->getItemName();
?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                                <h3 class="box-title">Donation Inventory - Withdraw Item</h3>
                                <form action="" method="POST" class="form-horizontal form-material">
                                    <div class="form-group">
                                    <div class="col-md-4">
             <select name="item" id="item" class="form-control form-control-line" style="width: 300px">
                <?php
                    while($rows= mysqli_fetch_assoc($result)){
                        echo "<option value=\"".$rows['DonationItem']."\">".$rows['DonationItem']."</option>";
                    }
                ?>
                                    ...
                                    <div class="col-md-2" style="margin-left: -20px">
                                        <input type="number" name="quantity" min="1" class="form-control form-control-line" placeholder="Item Quantity">
                                 ...
                                 <div class="col-md-2" style="margin-left: 13px">
                                  <div class="form-group" style="width: 300px">
                                        ...
                                        <div class="col-md-4"  style="margin-left: 13px">
                                            <div class="form-group" style="width: 811px">
                                            <input  name='textBox' type='text' class="form-control form-control-line" placeholder="Remarks" data-pattern='textOnly' required>
                                        </div>
                                            </div>
                                            <br><br><br><br><br><br><br><br><br><br>
                                             <div class="col-sm-2">
                                        <input type="submit" value="Withdraw Item" class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white;">
                                    </div>
