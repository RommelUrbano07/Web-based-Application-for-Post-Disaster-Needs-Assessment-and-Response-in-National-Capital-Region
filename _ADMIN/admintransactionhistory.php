...
<html lang="en">
    <head>
        ...
        <title>Admin Transaction History Logs - Admin</title>
        <link
            rel="canonical"
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title" style="font-size: 20px">Admin Transaction History Logs</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Admin Transaction History Logs</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="white-box">
                            <section>
                                ...
                                $result = $Inventory->PrintProcessLog();
                                ?>
                                <center>
                                <table class="content-table">
                                    <thead >
                                        <tr>
                                            <th style="color: white; text-align: center">Admin Name</th>
                                            <th style="color: white; text-align: center">Transaction Log</th>
                                            <th style="color: white; text-align: center">Transaction Date</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php while ($rows = mysqli_fetch_assoc($result)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo "'" . $rows['AdminTransactionLog'] . "'"; ?></td>
