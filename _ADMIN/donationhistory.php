...
<html lang="en">
    <head>
        ...
        <title>Donation History Logs - Admin</title>
        <link
            rel="canonical"
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title" style="font-size: 20px">Donation History Logs</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Donation History Logs</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="white-box">
                            <section>
                                ...
                                $PendingID=$Inventory->getDonationPendingID();
                                ?>
                                <center>
                                <table class="content-table">
                                    <thead >
                                        <tr>
                                            <th style="color: white; text-align: center">Donor Name/s</th>
                                            <th style="color: white; text-align: center">Donation Item/s</th>
                                            <th style="color: white; text-align: center">Date of Request</th>
                                            <th style="color: white; text-align: center">Date of Approval</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                        
                                        while($id= mysqli_fetch_assoc($PendingID)){
                                        
                                        ?>
                                        <tr>
                                            <td>
                                                <?php 
                                                $result= $Inventory->getDonationHistoryDonors($id['DonationPendingID']);
                                                
                                                while($rows=mysqli_fetch_assoc($result)){
                                                    echo " '".$rows['DonorFName']."' '".$rows['DonorMName']."' '".$rows['DonorLName']."' '".$rows['DonorSuffix']."' ";
                                                    echo "<br>";
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                <?php 
                                                $result= $Inventory->getDonationHistoryItems($id['DonationPendingID']);
                                                
                                                while($rows=mysqli_fetch_assoc($result)){
                                                    echo " '".$rows['DonationItem']."' : '".$rows['DonationQuantity']."'";
                                                    echo "<br>";
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                <?php 
                                                $result= $Inventory->getDonationHistoryDateRequest($id['DonationPendingID']);
                                                
                                                while($rows=mysqli_fetch_assoc($result)){
                                                    echo " '".$rows['DonationDate']."' ";
                                                    echo "<br>";
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                <?php 
                                                $result= $Inventory->getDonationHistoryDateAccept($id['DonationPendingID']);
                                                
                                                while($rows=mysqli_fetch_assoc($result)){
                                                    echo " '".$rows['DonationAcceptedDate']."' ";
                                                    echo "<br>";
                                                }
                                                ?>
                                            </td>
