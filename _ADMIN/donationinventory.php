...
<html lang="en">
    ...
    <head>
        ...
        <title>iRespondPH - Relief Item  Inventory</title>
        <link
            rel="canonical"
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title" style="font-size: 20px">Relief Item  Inventory</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Relief Item  Inventory</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                            ...
                            <div class="white-box">
                                <section>
                                    ...
                                    <table class="content-table" style="margin-left: 30px">
                                        <thead >
                                            <tr>
                                                ...
                                                <th style="color: white; text-align: center">Item Quantity</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            while ($rows = mysqli_fetch_assoc($Items)) {
                                                ...
                                                <tr class='tbodyDT' onclick='setActive(this);'>
                                                    <td scope='row' align='center'><span><?php echo $rows['DonationItem']; ?></span></td>
                                                    <td scope='row' align='center'><span><?php echo $rows['DonationQuantity']; ?></span></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <center>
                                        <div class="relative">
                                            <div class="navitem">
                                                <form method="POST" action="AdminAddItem.php">
                                                    <button type="submit" class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; height: 50px; margin-left: -100px; margin-top: -35px">Add</button>
                                                </form>
                                            </div>
                                            <div class="navitem">
                                                <input type="button" button id='retriever' value="Edit" class="btn btn-block waves-effect waves-light" onclick='retrieveRow(2);' style="background-color: orange; color: white; width: 170px; margin-left: -50px" class='btn btn-primary'/>
                                            </div>
                                            <div class="navitem">
                                                <input type="button" button id='retriever' value="Delete" class="btn btn-block waves-effect waves-light" onclick='retrieveRow(1);' style="background-color: orange; color: white; width: 170px" class='btn btn-primary'/>
                                            </div>
                                        </div>
                                    </center>
                                </section>
