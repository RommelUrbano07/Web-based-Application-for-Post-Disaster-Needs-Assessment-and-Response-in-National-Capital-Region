...
<html lang="en">
    <head>
        ...
        <title>Edit Family Registry - Admin</title>
        <link
            rel="canonical"
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title" style="font-size: 20px">Edit Family Registry</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="white-box">
                            <h1 style="text-align: center; font-weight: bold; margin-bottom: 10px">Search Family Head</h1>
                            <form method='POST' action='EditRedirect.php' class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Suffix (If Applicable)</label>
                                    <div class="col-md-12">
                                        <input
                                            type="text"
                                            name='Suffix'
