...
<html lang="en">
    <head>
        ...
        <title>iRespondPH - Register Admin</title>
        <link
            rel="canonical"
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="white-box">
                            <h1 style="text-align: center; font-weight: bold; margin-bottom: 10px">Sign Up</h1>
                            <form method='POST' action='registerAdminPROCESS.php' class="form-horizontal form-material">
                                ...
                                <center>
                                    ...
                                    <div class="col-sm-12">
                                        <input type="submit" class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; width: 170px"></a>
                                    </div>
