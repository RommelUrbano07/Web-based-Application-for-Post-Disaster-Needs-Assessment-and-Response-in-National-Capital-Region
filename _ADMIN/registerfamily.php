...
<html lang="en">
    ...
    <head>
        ...
        <title>iRespondPH - Register Family</title>
        <link
            rel="canonical"
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Register Family</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Register Family</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                                <legend><h4>Registration Form</h4></legend>
                                <form method='POST' action="registerPROCESS.php" id='forms'>
                                <input type='hidden' id='formLength' name='formLength' value='1' />
                                <div class='tab-pane' id='ls0'>
                                    <fieldset id='fs0'>
                                        <div class="form-group" >
                                            <input name='firstName0' type='text' class="form-control" class="form-control form-control-line" placeholder="First Name" title='First Name' data-pattern='textOnly' required>
                                        </div>
                                        <div class="form-group">
                                            <input name='middleName0' type='text' class="form-control" class="form-control form-control-line" placeholder="Middle Name" data-pattern='textOnly' required>
                                        </div>
                                        <div class="form-group">
                                            <input name='lastName0' type='text' class="form-control" class="form-control form-control-line" placeholder="Last Name" data-pattern='textOnly' required>
                                        </div>
                                        <div class="form-group">
                                            <input name='suffix0' type='text' class="form-control" class="form-control form-control-line" placeholder='Suffix' data-pattern='textOnly'>
                                        </div>
                                        <div class="form-group">
                                            <input name='contactNo0' class="form-control" type='tel' class="form-control form-control-line" placeholder="Contact No." minlength=11 maxlength=13 title='Contact Number' data-pattern='numberOnly' required>
                                        </div>
                                        <div class="form-group">
                                            <input type='text' class="form-control" class="form-control form-control-line" placeholder='House No.' name='houseNo0' title='House Number'>
                                        </div>
                                        <div class="form-group">
                                            <input type='text' class="form-control" class="form-control form-control-line" placeholder='Street Name' name='streetName0' title='Street Name' required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="custom-select" style='height: auto;'>
                                            ...
                                            <input type='date' class="form-control"  class="form-control form-control-line" placeholder="Birth Date" name='birthDate0' value="yyyy-mm-dd" class='birthdate' title='Birth Date' required>
                                        </div><br>
                                        <center>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                        ...
                                        <center>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="radio" id="male0" name="gender0" value="1" >
                                                    <label for="male0">Male </label>
                                                    <input type="radio" id="female0" name="gender0" value="0">
                                    ...
                                    <div id='BTNS'>
                                        <div class="relative">
                                            <center>
                                            <div class="navitem">
                                                <input type='button' class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; height: 50px" value='Add Form' onclick='addForm()'/>
                                            </div>
                                            <div class="navitem">
                                                <input type='button' class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; height: 50px" value='Remove Form' onclick='removeForm()'/>
                                            </div>
                                            </center>
                                            <br>
                                        </div>
...
<script>
            ...
            function addForm() {
                ...
                let form = $(
                        ...
                        "<input type='radio' id='male"+ formLength +"' name='gender"+ formLength +"' value='1'>"+
                        "<label for='male"+ formLength +"'>Male</label>"+
                        "<input type='radio' id='female"+ formLength +"' name='gender"+ formLength +"' value='0'>"+
