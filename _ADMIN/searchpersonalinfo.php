            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                                <h3 class="box-title">Search Person Information</h3>
                                <form method="POST" action="updatepersonalinfo.php" id='registrationForm' class="form-horizontal form-material">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="FirstName" placeholder='First Name' data-pattern='textOnly' required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="MiddleName" placeholder='Middle Name' data-pattern='textOnly' required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="LastName" placeholder='Last Name' data-pattern='textOnly' required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="Suffix" placeholder='Suffix  (If Applicable)' data-pattern='textOnly'/>
                                        </div>
                                    </div>
                                    <input type="submit"  value="Search" class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; width: 170px"/>
                                </form>
                            </div>
                        </div>
                    </div>
