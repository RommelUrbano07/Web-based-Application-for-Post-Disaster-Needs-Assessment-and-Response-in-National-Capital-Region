...
<html lang="en">
    <head>
        ...
        <title>iRespondPH - Update Personal Info</title>
        <link
            rel="canonical"
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="ActiveReportsDonations.php" class="waves-effect"><i class="fas fa-table" style="margin-right: 12px;"
                                                                                    aria-hidden="true"></i>Relief Request per City</a>
                        </li>
                    </ul>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Update Personal Info</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                                ...
                                <form method="POST" action="UpdatePersonInfoPROCESS.php">
                                            ...
                                            while ($rows = mysqli_fetch_assoc($PersonInformation)) {
                                                ...
                                                <fieldset id='fs0'>
                                                    <div class="form-group" >
                                                        <input type="hidden" value="<?php echo $rows['FirstName']; ?>" name="firstNameold">
                                                        <input type="hidden" value="<?php echo $rows['MiddleName']; ?>" name="middleNameold">
                                                        <input type="hidden" value="<?php echo $rows['LastName']; ?>" name="lastNameold">
                                                        <input type="hidden" value="<?php echo $rows['Suffix']; ?>" name="suffixold">
                                                        <input value='<?php echo $rows['FirstName']; ?>' name='firstName0' type='text' class="form-control" class="form-control form-control-line" placeholder="First Name" title='First Name' data-pattern='textOnly' required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value='<?php echo $rows['MiddleName']; ?>'name='middleName0' type='text' class="form-control" class="form-control form-control-line" placeholder="Middle Name" data-pattern='textOnly' required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value='<?php echo $rows['LastName']; ?>' name='lastName0' type='text' class="form-control" class="form-control form-control-line" placeholder="Last Name" data-pattern='textOnly' required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value="<?php
                                                        if ($rows['Suffix'] == ' ') {
                                                        ...
                                                        ?>"name='suffix0' type='text' class="form-control" class="form-control form-control-line" placeholder='Suffix' data-pattern='textOnly'>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value='<?php echo $rows['ContactNo']; ?>' name='contactNo0' class="form-control" type='tel' class="form-control form-control-line" placeholder="Contact No." minlength=11 maxlength=13 title='Contact Number' data-pattern='numberOnly' required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value='<?php echo $rows['HouseNo']; ?>' type='text' class="form-control" class="form-control form-control-line" placeholder='House No.' name='houseNo0' title='House Number'>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value='<?php echo $rows['StreetName']; ?>' type='text' class="form-control" class="form-control form-control-line" placeholder='Street Name' name='streetName0' title='Street Name' required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input value='<?php echo $rows['Subdivision']; ?>' type='text' class="form-control" class="form-control form-control-line" placeholder='Subdivision' name='subdivision' title='Subdivision'>
                                                    </div>
                                                    <div class="custom-select" style='height: auto;'>
                                                        <label for="gender" class="col-md-12">Birth Date </label>
                                                        <input value='<?php echo $rows['BirthDate']; ?>' type='date' class="form-control"  class="form-control form-control-line" placeholder="Birth Date" name='birthDate0' value="yyyy-mm-dd" class='birthdate' title='Birth Date' required>
                                                    </div><br>
                                                    <center>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                ...
                                <center>
                                    <p>
                                        PERSON IS NOT WITHIN OUR DATABASE
                                    </p>
                                </center>
                                <center>
                                    <div class="col-sm-3">
                            ...
                            <center>
                                ...
                                <div id='BTNS'>
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-center">
                                            <input type="submit"  class="btn btn-block waves-effect waves-light" style="background-color: orange; color: white; width: 170px" disabled/>  
                                        </div>
                                    </div>
                                </div>
                            </center>
