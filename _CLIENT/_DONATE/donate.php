            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="../../_CLIENT/_REPORT/report.php" class="nav-link">Report</a></li>
                        <li class="nav-item active"><a href="../../_CLIENT/_DONATE/donate.php" class="nav-link">Donate</a></li>
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                    <div class="col-md-9 ftco-animate pb-5 text-center">
                        <h2 class="mb-3 bread">Donate</h2>
                        <p>Donate now and save more lives!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
        <div class="container-fluid px-0">
            <div class="row no-gutters block-9">
                <div class="col-md-12 "> 
                    <form method="POST" action="DonateProcess.php" class="bg-light p-5 contact-form">
                        <input type='hidden' id='formPersonLength' name='formPersonLength' value='1' />
                        <input type='hidden' id='formNeedsLength' name='formNeedsLength' value='1' />
                        <h4 class="info-text">Item Information </h4>
                        <div class="row">
                            <div class="col-sm-12 ">
                                    ...
                                    <li id='needsForm0' class="list-group-item">
                                        <ul class='list-group list-group-horizontal'>
                                            <li class='list-group-item'>
                                                ...
                                                <textarea placeholder="Item Description" id='itemDescription' class='form-control' name='itemDescription' style='resize: none;' rows=10 cols=500 title='Item Description'></textarea><br>
                                            </li>
                                        </ul>
                                    <li id='needsForm0' class='list-group-item'>
                                        ...
                                        <input type='number' class='form-control' name='needsAmt0' placeholder='Quantity' style='width: 100px; text-align: center;' min='0' required>
                                    </li>
                                    </li>
                                </ul>      
                            </div>
                        ...
                        <div class="col-md-2 offset-md-5"> 
                            <input type='button' id='addForm1' class="form-control" value='Add Item' onclick='addForm(1)'/>
                            <input type='button' id='remForm1' class="form-control" value='Remove Item' onclick='removeForm(1)' disabled/>
                        </div>

                        <h4 class="info-text"> Donor Information </h4>
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="col-md-2 offset-md-5"> 
                            <input type='button' class='form-control' id='addForm0' value='Add Donor' onclick='addForm(0)'/>
                            <input type='button' class='form-control' id='remForm0' value='Remove Donor' onclick='removeForm(0)' disabled/>
                        </div>
                        <br><br>                                     
                        <br>
                        <div class = "row">
